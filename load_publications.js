...
function load_publications(){
	for (var i = 0; i < publications.length; i++) {
		...
		if (publications[i]['info']!='')
			html_text += '<table id="paper_info_table"><tr><td><i class="fa fa-info-circle" style="font-size:16px"></i></td><td>'+publications[i]['info']+'</td></tr>';
		...
		if (!jQuery.isEmptyObject(publications[i]['links'])) {
			html_text += '<table id="paper_links_table"><tr><td><i class="fa fa-hand-o-right" style="font-size:16px"></i></td>';
